...
local scripttabList = {
	...
	{"Dick Gun", "UR9FBjcj", 1},
	-- {"Dat Boi", "Sz7KJHay", 1},
	{"Watermelon Trap", "pypsM3hj", 1}, -- Added!
	{"Whip", "XDsek3Rf", 1}, -- Added!
	-- {"School Shooter", "EmmwRFDA", 1}, even if I had the script for this, I'm not adding this, it's fucked up
	{"9/11", "3UmV26hG", 1}, -- Added!
	{"Bong", "8Kb08E9s", 1},
...
local guitabList = {
	{"c00lgui", "Rz2EFsLU", 1}, -- Added!
	{"Topkek 4.0", "d0CJRrcg", 1}, -- Added!
	{"Topkek 3.0", "SikGfE9u", 1}, -- Added!
	...
	-- {"Music GUI", "U352cdsv", 1},
        {"Infinite Yield", "MjBzRjmT", 1}, -- Added!
}

local mapsList = {
	{"Clockwork Arena", "EvnXCXhP", 1}, -- Added!
	{"Town Map", 1345094164, 2},
	-- {"Cave Island", "t29C42rm", 1},
	{"Nature Map", "gmF4Kq5B", 1}, -- Added!
	{"Nazi Map", "az8sLCLT", 1},
	...
	{"World Trade Center", "3tvMcN48", 1},
	{"Krusty Krab", "1bVWvRui", 1},
}
...
local copy = true
	if pcall(function() Synapse:Copy("https://discord.gg/ezUzwNGwmQ") end) then
...
PopupText.Font = Enum.Font.SourceSansBold PopupText.FontSize = Enum.FontSize.Size28 PopupText.Text = "Our Discord server was recently deleted. Please join the new one here: https://discord.gg/ezUzwNGwmQ"
